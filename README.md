...
- **마이페이지** : 프로필 사진 · 닉네임 수정, 판매 상품 · 구매 내역 확인

### 🏷️ 상품 판매
- **상품 등록** : 사진 여러 장과 함께 카테고리 · 브랜드 · 사이즈 · 상태 · 가격 입력
- **상품 수정 / 삭제** : 판매 중 상품 정보 변경, 판매 완료 처리

### 🔍 상품 탐색
- **검색 · 상세 필터** : 키워드 검색에 카테고리 · 가격대 · 사이즈 · 상품 상태 조건을 조합
- **정렬** : 최신순 / 인기순(조회수 + 찜 수 반영)
- **홈 화면** : 신상품, 인기 TOP, 랜덤 추천, 지금 보는 상품과 비슷한 연관 상품

### 💖 찜
- **찜 추가 / 해제** : 마음에 드는 상품을 하트 버튼으로 저장
- **찜 목록** : 마이페이지에서 찜한 상품 모아보기

### 🛒 주문
- **상품 구매** : 판매 중인 상품 주문, 주문 상태 확인
- **주문 취소** : 구매자가 취소 요청하면 판매자 승인으로 확정
...
### 관리자
- **상품 블라인드** : 부적절한 상품을 가리고, 문제 해결 시 다시 노출
