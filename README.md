...
> **Nailed**는 옷장 속에 잠든 의류와 잡화를 필요한 사람에게 연결하는 **C2C 중고거래 플랫폼**입니다.

중고거래에서 가장 답답한 두 가지는 **"원하는 물건을 찾기 어렵다"**와 **"상대를 믿기 어렵다"**입니다.
Nailed는 이 두 가지를 풀고자 했습니다.

- **찾기 쉽게** — 판매자는 사진과 정보만 등록하면 되고, 구매자는 카테고리·가격대·사이즈·컨디션으로
  조건을 좁혀가며 딱 맞는 상품을 찾습니다. 단순 조회수가 아니라 찜과 관심도를 반영한 **인기순 추천**도 제공합니다.
- **믿고 거래하게** — 여러 장의 상품 이미지를 안전하게 다루는 **이미지 처리**, 부적절한 상품과
  악성 이용자를 걸러내는 **관리자 검수 체계**로, 서로 모르는 사람끼리도 안심하고 거래할 수 있게 설계했습니다.
